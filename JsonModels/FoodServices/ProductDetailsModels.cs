...
namespace UWOpenDataLib.JsonModels.FoodServices
{
    ...
    public class FoodServicesProductDetailsRoot
    {
    ...
    public class ProductDetailsData
    {
        ...
        public object serving_size_ml { get; set; }
        public object serving_size_g { get; set; }
        ...
        public object fat_trans_g { get; set; }
        public object fat_trans_percent { get; set; }
        ...
        public object carbo_fibre_g { get; set; }
        public object carbo_fibre_percent { get; set; }
        ...
        public object micro_nutrients { get; set; }
